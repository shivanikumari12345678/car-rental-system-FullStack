...
function CarDetails() {
  ...
  const handleSubmit=async(e)=>{
    e.preventDefault()
    try{
      console.log("id frin fribtebd",id)
  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      <button onClick={()=>navigate(-1)} className='flex ites-center gap-2 mb-6 text-gray-500 cursor-pointer'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
          ...
          <div className='space-y-6'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
              {[
                ...
                <div key={text} className='flex flex-col items-center bg-light p-4 rounded-lg'>
                  <img src={icon} alt="" className='h-5 mg-2'/>
                  {text}
                </div>
              ))}
            </div>
            ...
            <div>
              ...
              <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                {
                  ["360 Camera","Bluetooth","GPS","Heated Seats","Keyless Entry","Leather Seats",
        ...
        <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
              ...
              <button className='w-full bg-primary hober:bg-primary-dull transition-all py-3 font-medium text-white rounded-xl cursor-pointer'>Book Now</button>
